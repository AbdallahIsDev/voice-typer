...
| **Freestyle** | 231 | TypeScript + C | predecessor | Win/Mac/Linux | OpenAI, Groq, Anthropic, Google, Deepgram, ElevenLabs (cloud APIs) + local Whisper, Parakeet |
...
cutover complete 2026-09-17). predecessor packaging, TCP IPC, and
