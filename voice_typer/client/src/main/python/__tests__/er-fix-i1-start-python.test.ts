...
/**
 * ER-FIX-I1 / ER-1: startPython() calls createWindows() EAGERLY (before
 * tcpConnect) so the user sees UI within ~100–200ms instead of waiting
 * 2–5s for the Python TCP auth handshake. Also verifies ER-29
 * (clearTcpStartupTimeout reset) and ER-26 (_resetStopPythonFlagsForRestart)
