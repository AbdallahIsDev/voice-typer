...
import { PlayIcon, StopIcon, RefreshIcon } from '@hugeicons/core-free-icons'
  ...
  return (
    <div className="mt-4 rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" className="gap-1.5" onClick={onRetest}>
          <HugeiconsIcon icon={RefreshIcon} strokeWidth={1.625} className="h-3.5 w-3.5" />
          Retest
        </Button>
      </div>
        ...
        <>
          ...
          {quality.detected_issues.length > 0 && (
            <div className="text-[10px] text-(--text-muted) space-y-0.5">
              <span className="font-medium text-amber-500">Detected Issues:</span>
