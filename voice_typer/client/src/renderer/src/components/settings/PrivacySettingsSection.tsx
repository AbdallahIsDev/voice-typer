					...
					<div className="flex items-start gap-2">
						...
						<div className="text-sm text-(--text-muted) space-y-1.5 min-w-0">
							<p>
								...
								third parties — click
								<strong> Agree to All </strong> to enable every consent at once,
								or toggle individual features.
							</p>
							<ul className="list-disc pl-4 space-y-0.5 text-xs">
								<li>
									<strong>HuggingFace</strong>: downloads Whisper model weights
									(reveals your IP to a US third party; audio never leaves your
									machine).
								</li>
								<li>
								...
								<li>
									...
									<em> text </em>(not audio) to an OpenAI-compatible LLM API for
									refinement.
								</li>
								<li>
							...
							<p className="text-xs">
								You can revoke any consent at any time by toggling it off below.
								Cloud features will refuse to run until the relevant consent is
								re-granted.
							</p>
						</div>
					</div>
