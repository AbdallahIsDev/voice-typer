...
// no muted tint, no popper alignment, default bg-surface). This component
	...
	return (
		<Select value={value} onValueChange={(v) => onValueChange(v as SortOrder)}>
			...
			<SelectTrigger
				...
				className="text-muted-foreground transition-[color,box-shadow,background-color] hover:text-foreground"
			>
				<HugeiconsIcon
					icon={Sorting01Icon}
					strokeWidth={2}
