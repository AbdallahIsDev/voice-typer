...
const WAVE_BAR_HEIGHTS = [
	...
	44, 38, 54, 48, 32, 36, 50, 58, 42, 34, 48, 54, 38, 44, 60, 46, 34, 52, 56,
	40, 30, 48, 54, 38, 44, 58, 50, 36, 42,
];
const WAVE_BARS = WAVE_BAR_HEIGHTS.map((h, idx) => ({
	key: `bar-${idx}`,
	h,
	x: idx * (600 / 48) + 1.5,
}));
		...
		>
			...
			<div
				style={{
					...
					inset: 0,
					background:
						"linear-gradient(135deg, #0f0a1a 0%, #1a1040 40%, #0d1b2a 100%)",
				}}
			/>
