...
export const THEMES: ThemePreset[] = [
  ...
  // ── Amoled ───────────────────────────────────────────────────────────
  {
    id: 'amoled',
    name: 'Amoled',
    description: 'True-black backgrounds for deep contrast on OLED displays. Pure blacks save battery on AMOLED screens.',
    swatch: '#000000',
    light: {
  ...
  // ── Nord ────────────────────────────────────────────────────────────
  {
    id: 'nord',
    name: 'Nord',
    description: 'Cool arctic blues and frosty greys — inspired by the popular Nord colour palette.',
  ...
  // ── Dracula ──────────────────────────────────────────────────────────
  {
    id: 'dracula',
    name: 'Dracula',
    description: 'Rich purples and deep magentas — a dark-contrast theme inspired by the Dracula colour scheme.',
  ...
  // ── Sepia ────────────────────────────────────────────────────────────
  {
    id: 'sepia',
    name: 'Sepia',
    description: 'Warm amber tones and cream backgrounds — easy on the eyes, like reading a well-loved book.',
  ...
  // ── Custom ───────────────────────────────────────────────────────────
  {
    id: 'custom',
    name: 'Custom',
    description: 'Your own personalised colours — configure each colour in the editor below.',
  ...
  // ── Solarized ────────────────────────────────────────────────────────
  {
    id: 'solarized',
    name: 'Solarized',
    description: 'A balanced palette with warm yellows and cool teals — designed for readability and reduced eye strain.',
...
export function deriveCustomVars(
  ...
  const bg = core['--background'] ?? (isDark ? DEFAULT_CUSTOM_DARK['--background'] : DEFAULT_CUSTOM_LIGHT['--background'])
  const fg = core['--foreground'] ?? (isDark ? DEFAULT_CUSTOM_DARK['--foreground'] : DEFAULT_CUSTOM_LIGHT['--foreground'])
  const primary = core['--primary'] ?? (isDark ? DEFAULT_CUSTOM_DARK['--primary'] : DEFAULT_CUSTOM_LIGHT['--primary'])
  const subtle = core['--bg-subtle'] ?? (isDark ? DEFAULT_CUSTOM_DARK['--bg-subtle'] : DEFAULT_CUSTOM_LIGHT['--bg-subtle'])
  const border = core['--border'] ?? (isDark ? DEFAULT_CUSTOM_DARK['--border'] : DEFAULT_CUSTOM_LIGHT['--border'])
  const muted = core['--text-muted'] ?? (isDark ? DEFAULT_CUSTOM_DARK['--text-muted'] : DEFAULT_CUSTOM_LIGHT['--text-muted'])
