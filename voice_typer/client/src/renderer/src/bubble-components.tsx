 ...
 *
 * DR-16: the former 823-line monolith has been split into the
 * `./bubble/` package (constants, helpers, hooks, and one file per
 * component). This file remains only so existing consumers that import
 * from `"./bubble-components"` (notably `Bubble.tsx`) keep working
 * without churn. New code should import directly from `./bubble`.
 *
