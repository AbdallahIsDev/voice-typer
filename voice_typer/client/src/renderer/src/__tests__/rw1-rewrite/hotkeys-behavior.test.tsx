/**
 * RW-1 vitest rewrite — behavioral tests for hotkey-related TS modules
 ...
 * fails.
 *
 * NOTE: tests that overlap with the RW-0 rewrite
 * (`__tests__/rw0-rewrite/hotkey-utils-behavior.test.ts` and
 * `__tests__/rw0-rewrite/RecordingSettings-hotkey-picker.test.tsx`)
 * are NOT duplicated here — the RW-0 file already covers
...
// RW-0 rewrite (RecordingSettings-hotkey-picker.test.tsx); replicating
// it here keeps the RW-1 test self-contained.
