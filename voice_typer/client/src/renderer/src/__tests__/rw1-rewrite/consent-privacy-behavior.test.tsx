/**
 * RW-1 vitest rewrite — behavioral tests for consent & privacy UI.
 *
 ...
 *
 * Python tests already skipped in the prior RW-0 round (with their own
 * vitest counterparts in `__tests__/rw0-rewrite/`):
