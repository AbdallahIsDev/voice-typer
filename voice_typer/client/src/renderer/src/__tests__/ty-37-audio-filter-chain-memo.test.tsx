/**
 * TY-37 regression test: `AudioFilterChain` labels are memoised.
 *
...
describe("TY-37: AudioFilterChain labels are memoised", () => {
	...
	it("does NOT re-resolve labels on re-render with the same props", () => {
		...
		// Pre-TY-37: secondRenderCount would have been ~80 (all label
		// constants re-resolved + all inline calls). Post-TY-37: the
