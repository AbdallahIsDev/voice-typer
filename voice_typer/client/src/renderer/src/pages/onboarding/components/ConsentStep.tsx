...
export default function ConsentStep({
	...
	return (
		<>
			...
			<div className="mb-4 flex items-center justify-between gap-3 rounded-lg border border-border bg-(--bg-subtle) px-3.5 py-3">
			...
			<div className="space-y-3">
				{CONSENT_STEP_FIELDS.map(({ field, labelKey, infoKey }) => (
					<div key={field} className="rounded-lg border border-border p-3.5">
