...
export function useTheme(
                ...
                useCallback(
                        (data): (() => void) | undefined => {
                                ...
                                if (typeof data.theme_preset === "string") {
                                        setThemePresetState(data.theme_preset as VoiceTyperConfig["theme_preset"]);
                                }
        ...
        const themeSaveTimerRef = useRef<ReturnType<typeof setTimeout> | null>(
                null,
        );
                ...
                (
                        ...
                        themeSaveTimerRef.current = setTimeout(async () => {
                                ...
                                try {
                                        ...
                                        // Theme is local-only if backend unavailable
                                        console.warn(
                                                "[useTheme] set_config (debounced) failed:",
                                                e,
                                        );
                                }
                        }, 300);
