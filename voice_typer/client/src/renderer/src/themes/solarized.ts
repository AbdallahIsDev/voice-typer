...
export const solarizedTheme: Omit<ThemePreset, "nameKey"> = {
	...
	dark: {
		...
		/* WCAG AA: --accent L=0.55 + chroma 0.08 in dark mode means the
		   default white --accent-foreground only reaches ~4.3:1.
		   Lowering the accent L to 0.53 lets white clear AA 4.5:1
		   against the slightly deeper teal. */
		"--accent": "oklch(0.53 0.08 160)",
		"--accent-foreground": "oklch(0.97 0 0)",
