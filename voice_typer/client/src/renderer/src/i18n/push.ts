...
export function trayLabelsForLocale(): Record<string, string> {
	...
	const entries: [string, string][] = [
		...
		["notify.native_adapter.warn_title", "notify.native_adapter.warn_title"],
		[
		...
		["notify.model.delete.unknown_model", "notify.model.delete.unknown_model"],
		[
			"notify.model.delete.not_downloaded",
			"notify.model.delete.not_downloaded",
		],
		[
