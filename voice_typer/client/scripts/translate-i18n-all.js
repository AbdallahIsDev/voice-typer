...
const _aboutKeys = (t) => ({
	...
	"about.updatesDescription": t(
		"Check for newer versions of Lausu.",
		"Nach neueren Versionen von Lausu suchen.",
		"Buscar versiones más recientes de Lausu.",
		"Rechercher les versions plus récentes de Lausu.",
		"Lausu के नए संस्करणों की जाँच करें।",
		"Проверить наличие новых версий Lausu.",
		"检查 Lausu 的更新版本。",
	),
	...
	"about.creditsDescription": t(
		"Lausu is built on the shoulders of giants.",
		"Lausu steht auf den Schultern von Giganten.",
		"Lausu está construido sobre hombros de gigantes.",
		"Lausu est construit sur les épaules de géants.",
		"Lausu दिग्गजों के कंधों पर बनाया गया है।",
		"Lausu построен на плечах гигантов.",
		"Lausu 站在巨人的肩膀上。",
	),
