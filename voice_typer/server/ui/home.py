...
import re
import flet as ft
from voice_typer.server.ui.styles import Tokens, SETTINGS_MAX_WIDTH, STATUS_COLORS, STATUS_LABELS, RECORD_BUTTON_SIZE, RECORD_BUTTON_COLOR
from voice_typer.server.ui.icons import icon
