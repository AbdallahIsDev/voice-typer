...
_TRAY_LABELS_AR: dict[str, str] = {
    ...
    "more_models": "المزيد من النماذج...",
    "refresh_mics": "تحديث الميكروفونات",
    "settings": "الإعدادات...",
    "history": "السجل...",
    "help": "مساعدة...",
...
_TRAY_LABELS_DE: dict[str, str] = {
    ...
    "more_models": "Weitere Modelle...",
    "refresh_mics": "Mikrofone aktualisieren",
...
_TRAY_LABELS_FR: dict[str, str] = {
    ...
    "refresh_mics": "Actualiser les microphones",
    "settings": "Paramètres...",
    "history": "Historique...",
    "help": "Aide...",
...
_TRAY_LABELS_HI: dict[str, str] = {
    ...
    "more_models": "अधिक मॉडल...",
    "refresh_mics": "माइक्रोफ़ोन रिफ्रेश करें",
    "settings": "सेटिंग्स...",
    "history": "इतिहास...",
    "help": "सहायता...",
...
_TRAY_LABELS_RU: dict[str, str] = {
    ...
    "more_models": "Другие модели...",
    "refresh_mics": "Обновить микрофоны",
    "settings": "Настройки...",
    "history": "История...",
    "help": "Справка...",
