...
class VadProcessor:
    ...
    # @property/@setter boilerplate. Recorder exposes them through
    # property shims named ``_vad_*`` so historical tests that do
    # ``rec._vad_state = X`` keep working. The 2 threshold-dB
