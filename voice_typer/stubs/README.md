...
| --------------------- | --------------------------------- | --------- | ---------------------------------------- |
| `pycaw.pycaw`         | `pycaw`                           | Windows   | `server/volume_backends/` (WinVolume)  |
| `comtypes`            | `comtypes`                        | Windows   | `server/volume_backends/`, `server/clipboard/` (UIA) |
| `comtypes.client`     | `comtypes`                        | Windows   | `server/clipboard/` (UIA)              |
| `CoreAudio`           | `pyobjc-framework-CoreAudio`      | macOS     | `server/volume_backends/` (MacVolume)  |
