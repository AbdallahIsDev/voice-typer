# PYREFLY-001 / TASK-10: permissive stub for stdlib ``ctypes``.
#
# This is a verbatim copy of typeshed's ctypes/__init__.pyi with one
# modification: the ``if sys.platform == "win32":`` guards around
# ``windll`` / ``oledll`` / ``WinDLL`` / ``OleDLL`` / ``HRESULT`` /
# ``WINFUNCTYPE`` / ``FormatError`` / ``GetLastError`` / ``get_last_error``
# / ``set_last_error`` / ``WinError`` / ``DllCanUnloadNow`` /
# ``DllGetClassObject`` have been REMOVED so pyrefly can follow the
# Windows code paths in clipboard.py / hotkeys.py / app.py /
# prewarm.py / microphone_watcher.py on the Linux CI runner.
#
...
class LibraryLoader(Generic[_DLLT]):
    ...
    def LoadLibrary(self, name: str) -> _DLLT: ...  # noqa: N802
...
_WritableBuffer = bytearray | memoryview | array | _CData  # noqa: F821
...
_CVoidPLike = _PointerLike | Array[Any] | _CArgObject | int  # noqa: F821
...
def byref(obj: Any, offset: int = ...) -> _CArgObject: ...

_CastT = TypeVar("_CastT", bound=_CanCastTo)

# TASK-10: relaxed to Any for the obj parameter (same rationale as byref).
def cast(obj: Any, type: type[_CastT]) -> _CastT: ...  # noqa: A002
...
# TASK-10: Win32-only functions declared unconditionally (see file header).
def DllCanUnloadNow() -> int: ...  # noqa: N802
...
class pointer(Generic[_CT], _PointerLike, _CData):  # noqa: N801
    # TASK-14: PEP 526 disallows TypeVars inside ClassVar[...], so we
    # widen to ``ClassVar[Any]`` (matches runtime: ``_type_`` is the
    # pointed-to ctypes class, which is fully dynamic at the stub level).
    _type_: ClassVar[Any] = ...
    contents: _CT = ...
...
class c_byte(_SimpleCData[int]): ...  # noqa: N801

class c_char(_SimpleCData[bytes]):  # noqa: N801
    def __init__(self, value: int | bytes = ...) -> None: ...

class c_char_p(_PointerLike, _SimpleCData[bytes | None]):  # noqa: N801
    def __init__(self, value: int | bytes | None = ...) -> None: ...

class c_double(_SimpleCData[float]): ...  # noqa: N801
class c_longdouble(_SimpleCData[float]): ...  # noqa: N801
class c_float(_SimpleCData[float]): ...  # noqa: N801
class c_int(_SimpleCData[int]): ...  # noqa: N801
class c_int8(_SimpleCData[int]): ...  # noqa: N801
class c_int16(_SimpleCData[int]): ...  # noqa: N801
class c_int32(_SimpleCData[int]): ...  # noqa: N801
class c_int64(_SimpleCData[int]): ...  # noqa: N801
class c_long(_SimpleCData[int]): ...  # noqa: N801
class c_longlong(_SimpleCData[int]): ...  # noqa: N801
class c_short(_SimpleCData[int]): ...  # noqa: N801
class c_size_t(_SimpleCData[int]): ...  # noqa: N801
class c_ssize_t(_SimpleCData[int]): ...  # noqa: N801
class c_ubyte(_SimpleCData[int]): ...  # noqa: N801
class c_uint(_SimpleCData[int]): ...  # noqa: N801
class c_uint8(_SimpleCData[int]): ...  # noqa: N801
class c_uint16(_SimpleCData[int]): ...  # noqa: N801
class c_uint32(_SimpleCData[int]): ...  # noqa: N801
class c_uint64(_SimpleCData[int]): ...  # noqa: N801
class c_ulong(_SimpleCData[int]): ...  # noqa: N801
class c_ulonglong(_SimpleCData[int]): ...  # noqa: N801
class c_ushort(_SimpleCData[int]): ...  # noqa: N801
class c_void_p(_PointerLike, _SimpleCData[int | None]): ...  # noqa: N801
class c_wchar(_SimpleCData[str]): ...  # noqa: N801

class c_wchar_p(_PointerLike, _SimpleCData[str | None]):  # noqa: N801
    def __init__(self, value: int | str | None = ...) -> None: ...

class c_bool(_SimpleCData[bool]):  # noqa: N801
...
class _StructUnionMeta(_CDataMeta):
    ...
    def __getattr__(self, name: str) -> _CField: ...  # noqa: N804
