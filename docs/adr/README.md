...
| 0015 | `0015-electron-command-allowlist.md` | Electron-Side Command Allowlist (SEC-019) | Accepted — implemented in `client/src/main/allowed-commands.ts` (ALLOWED_COMMANDS, ≈ lines 40–159; was `index.ts:532-627` before the allowlist was extracted into its own module). |
