...
- `voice_typer/server/ipc_server.py` (2,478 lines) — `_COMMAND_REGISTRY` at line 1796 (73 commands — see §2 IPC-1 reconciliation), `_validate_dict_payload` at line 62, `_push_event_now` at line 544, `push` at line 1915, `ready` emit at line 2426, `_handle_heartbeat` at line 1583, `_handle_relaunch_ack` at line 1602.
