...
# ── CR-11: per-process rate limiter persists across reconnects ─────────


class TestCR11PerProcessRateLimiter:
    ...
    def test_budget_persists_across_simulated_reconnect(self):
        ...
        # CR-11 fix: this must return the SAME instance with the budget
