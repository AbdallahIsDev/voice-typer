...
# ----------------------------------------------------------------------
# ER-53: Config backup skipped when content matches _last_saved_bytes
# ----------------------------------------------------------------------
...
class TestConfigSaveBackupSkip:
    ...
    def test_backup_read_skipped_on_identical_resave(self, tmp_path, monkeypatch):
        ...
        # read after the first save. The ER-53 optimization should make
...
# ----------------------------------------------------------------------
# ER-78: multi-row INSERT batches 3+ pending rows
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# ER-80: _secure_atomic_write(durability=False) skips fsyncs
# ----------------------------------------------------------------------
