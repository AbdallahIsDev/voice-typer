...
# ==============================================================================
# Merged from tests/test_llm_polish_http_fixes.py —
#   LLM-polish HTTP regression pins (MAX_INPUT_CHARS guard, configurable timeout_s, flat max_tokens, PII-redaction
#   fail-closed, HTTP error branches)
# ==============================================================================
