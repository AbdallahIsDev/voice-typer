...
# Python ↔ TS exact-membership parity ─────────────────────────
...
# Python ↔ Rust exact-membership parity ───────────────────────
...
def test_every_python_command_is_in_rust_except_documented_exceptions() -> None:
    ...
    # ``_TS_ONLY_EXCEPTIONS`` are commands in the Python registry
...
# documentation invariants on the exception set ───────────────
