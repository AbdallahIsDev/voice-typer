...
``controller.quit()`` — see TestUE1Win32RoutingFastCleanup below.
...
class TestXZ_R17_06_FastCleanup:  # noqa: N801
    ...
    def test_do_fast_cleanup_idempotent(self, _stub_os_exit):
        ...
        # UE-1: os._exit(0) must have been called twice (once per
...
# ── UE-1: _do_fast_cleanup ends with os._exit(0) + win32 routing ─────


class TestUE1FastCleanupOsExit:  # noqa: N801
...
# ── UE-1: win32_console_handler routing ──────────────────────────────


class TestUE1Win32RoutingFastCleanup:  # noqa: N801
