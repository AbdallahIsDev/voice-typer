...
# ─── XZ-PII-03: redact_pii now also redacts API keys + URL credentials ──
...
class TestRedactPiiAlsoRedactsApiSecrets:
    ...
    def test_pii_patterns_still_masked(self) -> None:
        ...
        # after the XZ-PII-03 change (already pinned by
...
# ─── XZ-PII-05: _apply_llm_polish failure log redacts the exception ──────
...
# ─── XZ-PII-06: cloud_engines redaction is consistent across branches ────
...
class TestCloudEnginesRedactionConsistency:
    ...
    def test_no_redact_secret_only_branches_in_cloud_engines(self) -> None:
        ...
        # The XZ-PII-06 fix removed every ``redact_secret(str(exc))``
