...
_SAFE_LOG_CALL_SITES: dict[str, set[str]] = {
    ...
    # (NOT the raw text) — see XZ-PII-04. The line is gated behind
    ...
    # call (see SEC-009 / XS-20). The hallucination rejection log uses
    ...
    # INFO level without ``redact_pii``. This is a XZ-LOG-12 finding
    # tracked for a separate fix (the file is outside the FIX-10
...
class TestXZLog12NoRawTranscriptionInLogs:
