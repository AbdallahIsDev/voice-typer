...
# ── ER-54: tray tooltip uses time.monotonic() ────────────────────────────
...
class TestER54TrayMonotonicElapsed:
...
# ── ER-55: templates lazy variable resolution + hoisted regex ────────────


class TestER55TemplatesLazyClipboard:
...
class TestER55TemplatesWhitespaceRegexCompiledOnce:
...
# ── ER-64: _secrets _LOOPBACK_HOSTS module-level ─────────────────────────


class TestER64LoopbackHostsModuleLevel:
