...
class TestDetectGpu:
    def test_detect_gpu_no_cuda(self):
        ...
        from voice_typer.asr_setup import detect_gpu
...
class TestCheckDependencies:
    def test_check_dependencies_returns_dict(self):
        from voice_typer.asr_setup import check_dependencies
...
class TestPipInstall:
    def test_pip_install_empty_packages(self):
        from voice_typer.asr_setup import pip_install
        assert pip_install([]) is True

    @patch("voice_typer.asr_setup.subprocess.run")
...
class TestDownloadWeights:
    def test_download_weights_already_cached(self):
        from voice_typer.asr_setup import download_weights
