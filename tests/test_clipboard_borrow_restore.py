...
environment so any incidental pynput usage doesn't crash the suite.
"""
...
# DISPLAY must be set so any code that lazily instantiates a pynput
# Controller doesn't blow up. Xvfb is running on :99 in CI.
