...
# per-file warm log demoted to DEBUG ──────────────────────────


class TestWarmFileLogLevel:
...
# suffix filter on _warm_package_files ────────────────────────
...
# no sorted() wrapper in _warm_package_files ──────────────────


class TestNoSortedWrapper:
...
# TTL memoization of cache-ratio probe ────────────────────────


class TestCacheProbeMemoization:
...
# @lru_cache on _resolve_hf_cache_dir + cached Config ─────────
