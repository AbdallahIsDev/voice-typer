...
# ────────────────────────────────────────────────────────────────────────────
# DE-42: control-char rejection in _handle_show_electron_notification
# ────────────────────────────────────────────────────────────────────────────


class TestDE42ControlCharRejection:
...
# ────────────────────────────────────────────────────────────────────────────
# DE-43: _handle_get_status try/except + payload validation
# ────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────
# DE-44: restore_history payload + per-field caps
# ────────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────────
# DE-45: microphone_test_start duration clamp_range
# ────────────────────────────────────────────────────────────────────────────


class TestDE45DurationClampRange:
...
# ────────────────────────────────────────────────────────────────────────────
# DE-46: run_prewarm / open_prewarm_log fixed-string error messages
# ────────────────────────────────────────────────────────────────────────────


class TestDE46RunPrewarmNoStrEcho:
